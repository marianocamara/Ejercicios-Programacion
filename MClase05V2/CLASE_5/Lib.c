...
int mostrarDatosAlta(int edad[], float salario[], int qtyMaxima)
{
    int i;
...
int mostrarDatosBaja(int edad[], float salario[], int qtyMaxima, int* numeroBaja)
{
    int i;
    int acumuladorBaja = 0;
    printf("\nEDAD\t\tSALARIO");
    for(i = 0; i < qtyMaxima; i++)
    {
        if (edad[i] == -1)
